...
> 「More ways to earn」の **`a Shop`** リンクから Shop を有効化します。
...
| 用途 | ファイル |
| --- | --- |
| 商品① 配信ファイル | `output/日本の国宝ガイド_姫路城.pdf` |
| 商品① サムネイル | `output/thumb_姫路城_ja.png` |
| 商品② 配信ファイル | `output/Japans-National-Treasures_Himeji-Castle.pdf` |
| 商品② サムネイル | `output/thumb_Himeji_en.png` |

GitHub の `output/` フォルダからダウンロードしておいてください。
...
・基本データ
・第1章 歴史 ― 三人の城主と、二度の危機
   秀吉・池田輝政・本多忠政/千姫の物語/明治の廃城危機/戦火を免れた奇跡/二度の大修理
・第2章 建築を読む ― 連立式天守/白漆喰総塗籠/迷路のような縄張り/狭間と石落とし
・第3章 歩いて巡る ― 見学ルート、所要時間別プラン、見どころ
・第4章 訪問ガイド ― 拝観情報、アクセス、四季、好古園、姫路の味

写真8点・明治初期の絵図・オリジナル図解を収録しています。

【仕様】
PDF / A4縦 / 全11ページ / 約5.2MB
スマホ・タブレット・PCで閲覧できます。
...
History from the castle's founding to the present day, how to actually read
the architecture, a walking route with realistic timings, the seasons,
access from the nearest station, what's nearby and what to eat.
...
· Chapter 1 — History: three lords and two brushes with destruction
   Hideyoshi, Ikeda Terumasa and Honda Tadamasa / Princess Sen /
   the Meiji demolition order / surviving the 1945 air raids / two great restorations
· Chapter 2 — Reading the architecture: the connected keep, white plaster,
   the path built as a maze, loopholes and stone drops
· Chapter 3 — Walking the castle: route, timings, what not to miss
· Chapter 4 — Visiting: admission, access, seasons, Koko-en garden, local food

Includes eight photographs, an early-Meiji bird's-eye painting of the castle,
and an original diagram.

SPECIFICATIONS
PDF / A4 / 11 pages / approx. 4.3MB
...
- [ ] サムネイルが表示されている
- [ ] **自分で購入テスト**をして、ダウンロードが届くか確認した
- [ ] 商品ページのプレビューで説明文の改行が崩れていない

### テスト購入のやり方

**自分のアカウントからは自分の商品を買えないことが多い**ため、次の手順で行います。

1. ブラウザの**シークレット(プライベート)ウィンドウ**を開く
2. `https://ko-fi.com/zenkyu` を開く(未ログイン状態になる)
3. Shop から商品を選んで購入する
4. **普段と違うメールアドレス**を入力(Gmail なら `〜+test@gmail.com` が使える)
5. 決済する

**費用**:¥500 を払い、手数料を引いた額が自分に戻る。実質負担は数十円程度。
ダウンロードが届かない商品を売ってしまうリスクを考えれば安い。

> 💡 Shop の設定に**割引コード**の機能があれば、100%オフのコードを自分で使う方法もあります。
> 価格を一時的に **¥0** にして無料DLでテストし、確認後に戻す手も(Ko-fi が ¥0 商品を許可していれば)。

**確認する5点**

1. ダウンロードリンクが届くか(画面表示とメールの両方)
2. **ファイルが正しいか** — 日本語版を買ったのに英語版が届いていないか
3. PDFが開けて、11ページあるか
4. 購入者向けメッセージが表示されるか
5. Shop → Orders に注文が記録されているか

> ⚠️ **特に2番**。日英2商品を登録すると、**アップロードするファイルを取り違えやすい**箇所です。
> 内容は同じで言語だけ違うため、間違えても登録画面では気づけません。

テスト後の注文はそのままで実害ありません。返金する場合、手数料は戻らないことが多いので、
数十円のために手間をかける必要はありません。
...
| 時期 | やること |
| --- | --- |
| 完了 | 姫路城・犬山城・彦根城・松江城、**英語版4点をKo-fi Shopに出品済み** |
| 次 | 彦根城・松江城の**日本語版PDF作成**→登録 / 松本城の画像収集(保留中)を再開するか判断 |
